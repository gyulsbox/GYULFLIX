...
import { getTv, getTvImages, getTvTrailer, IGetTvImages, IGetTvResult, IGetTvTrailer } from "../../Api/api";
          ...
          <AnimatePresence>
            {ModalMatch ? (
              <>
                ...
                <Modal style={{ top: scrollY.get() + 100 }} layoutId={ModalMatch.params.tvId}>
                  {clickedTv && (
                    <>
                      <ModalCover>
                        <TvDetail />
